...
Project X-Ray across 15 dimensions. Outcome: scoreboard with ratings from 0 to 10.

## Steps

1. **Loading:** Read the skills in `.agents/skills/auditoria/` sequentially (00 to 14).
...
4. **MANDATORY PAUSE:** After displaying the score and points of attention, the agent MUST ask:
    > "Devo prosseguir com a execução para corrigir estes pontos de atenção? Responda: OK, PULAR, ou REPETIR."
